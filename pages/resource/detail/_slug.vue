<template>
    <div class="border-t border-gray-900 dark:border-gray-300 my-6">
        <article class="my-6">
            ...
            <div class="dark:text-gray-300">
                <figure class="w-72 h-96 mx-auto border">
                    <img :src="data.cover" class="w-72 h-96" height="350" width="278" />
                </figure>
        ...
        <!-- <section class="flex items-center justify-center my-6">
            <button
                type="button"
                @click="download(data.code)"
                class="rounded-md px-4 py-2 border border-gray-800 dark:text-gray-200 dark:hover:bg-gray-600 hover:bg-gray-100 dark:border-gray-200"
            >Download</button>
        </section> -->
    </div>
</template>
