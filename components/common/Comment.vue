<template>
    <div class="space-y-4 my-8">
        <div class="flex">
            ...
            <div
                class="flex-1 border rounded px-4 py-2 sm:px-6 sm:py-4 leading-relaxed dark:text-gray-300"
            >
                <strong class="mr-4">Sarah</strong>
            ...
            >
                ...
                <div class="space-y-4">
                    <div class="flex">
                        ...
                        <div
                            class="flex-1 bg-gray-100 dark:bg-gray-600 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed"
                        >
                            <strong class="mr-4">Sarah</strong>
                            <span class="text-xs text-gray-400">3:34 PM</span>
