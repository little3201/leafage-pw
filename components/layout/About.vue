<template>
    <div>
        ...
        <div class="lg:flex lg:border-t border-black dark:border-gray-100 dark:text-gray-100">
            <div
            ...
            >
                <NuxtLink
                    title="关于网站"
                    class="w-full whitespace-nowrap lg:block p-3 hover:bg-black hover:text-white dark:hover:bg-gray-100 dark:hover:text-black"
                    to="/about"
                >关于网站</NuxtLink>
                <NuxtLink
                    title="关于作者"
            ...
            <div class="my-4 lg:p-4 mx-auto w-full lg:border-l">
                <article class="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:text-gray-100 prose-blue mx-auto">
                    <slot />
                </article>
            </div>
        </div>
...
.router-link-exact-active {
    @apply text-white bg-black dark:text-black dark:bg-gray-100;
}
</style>