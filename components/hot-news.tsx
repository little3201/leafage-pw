        ...
        <div className="relative">
            <article className="flex flex-row">
                <div className="relative mr-14" style={{ height: 480, width: `calc(50vw + 235px)` }}>
                    <div className="absolute inset-0 overflow-hidden bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${posts[0].cover})` }}></div>
                        ...
                        <li className="w-1/2 px-4 inline-block my-2" key={post.code}>
                            <article className="flex items-center justify-start">
                                <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4 flex-shrink-0">
                                    <div className="absolute inset-0 overflow-hidden bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${post.cover})` }}></div>
                                    <Link as={`/posts/${post.code}`} href="/posts/[slug]">
                                        <a className="absolute inset-0"></a>
                                    </Link>
                                </div>
                                <div className="p-0">
                                    <a className="pb-2 font-medium uppercase text-xs text-green-700" href="/logen/tag/fashion/">{post.category}</a>
