        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            <button
              ...
              type="button"
              class="hidden group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              <span>Solutions</span>
              <!--
          ...
          -->
            ...
            >
              ...
              >
                ...
                <div
                  class="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8 bg-white"
                >
                  <div class="flow-root">
                    <a
                      href="#"
          ...
          -->
            <div
              :class="isOpen ? '' : 'hidden'"
              class="absolute left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0 bg-white"
            >
              <div
                class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden"
              >
