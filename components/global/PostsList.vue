<template>
  <div class="my-6">
    ...
    >
      <div class="w-full" v-for="data in datas" :key="data.code">
        ...
        <div class="my-2">
          ...
          ></nuxt-link>
          <h3 class="font-bold my-2 transform hover:translate-x-2 transition duration-500">
            <nuxt-link :title="data.code" :to="'/posts/detail/' + data.code" v-text="data.title"></nuxt-link>
          </h3>
          <ul class="inline-flex text-xs space-x-2 md:space-x-6 text-gray-600 uppercase">
    ...
    <div
      v-else
      class="animate-pulse grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8"
    >
