...
import { SunIcon, MagnifyingGlassIcon, Bars3Icon } from '@heroicons/react/24/outline'
            ...
            <div className="flex-shrink-0 flex items-center justify-end text-neutral-700 dark:text-neutral-100 space-x-1">
                ...
                <div className="flex items-center xl:hidden">
                    <button className="py-2.5 rounded-lg text-neutral-700 dark:text-neutral-300 focus:outline-none flex items-center justify-center">
                        <Bars3Icon className="h-7 w-7 text-neutral-700 dark:text-neutral-300" aria-hidden="true" />
                    </button>
                </div>
            </div>
        </header >
