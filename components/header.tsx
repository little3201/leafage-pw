            ...
            <div className="flex-shrink-0 flex items-center justify-end text-neutral-700 dark:text-neutral-100 space-x-1">
                <div className="hidden items-center xl:flex space-x-1">
                    ...
                    <div className="relative">
                        <button type="button" title='search_button' className="w-10 h-10 rounded-full hover:bg-lime-50 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center transition-colors duration-200" id="dark" aria-expanded="false">
                            <MagnifyingGlassIcon className="h-6 w-6 text-neutral-700 dark:text-neutral-300" aria-hidden="true" />
                        </button>
                    </div>
                    <div className="relative">
                        <Link href="https://github.com/little3201" target="_blank" className="w-10 h-10 rounded-full text-neutral-700 dark:text-neutral-300 hover:bg-lime-50 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center transition-colors duration-200" id="search" type="button" aria-expanded="false">
