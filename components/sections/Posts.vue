  ...
  <div class="container mx-auto my-8 px-6">
    <div class="md:flex mt-8 md:-mx-4">
      <div
        ...
        :style="{ 'background-image': 'url(' + datas[idx].imageUrl + ')' }"
      >
        <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
          <div class="px-10 max-w-xl">
            <h2
              class="md:text-2xl text-white font-semibold"
              v-text="datas[idx].title"
            >
              Sport Shoes
            </h2>
            <p class="mt-2 text-gray-400 hidden lg:block" v-text="datas[idx].subtitle"></p>
            <nuxt-link
              :to="'/blog/detail/' + datas[idx].businessId"
              class="flex items-center mt-4 px-3 py-2 text-white text-sm uppercase font-medium rounded hover:underline focus:outline-none"
            >
              <span>Shop Now</span>
              <svg
                class="h-5 w-5 mx-2"
    ...
    <div class="md:flex mt-8 md:-mx-4">
      <div
        ...
        :style="{
          'background-image': 'url(' + datas[index + 2].imageUrl + ')',
        }"
      >
        <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
          <div class="px-10 max-w-xl">
            <h2
              class="md:text-2xl text-white font-semibold"
              v-text="datas[index + 2].title"
            ></h2>
            <p
              class="mt-2 text-gray-400 hidden lg:block"
              v-text="datas[index + 2].subtitle"
            ></p>
            <nuxt-link
              :to="'/blog/detail/' + datas[index + 2].businessId"
