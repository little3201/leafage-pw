                ...
                <div class="grid grid-flow-col grid-rows-2 grid-cols-2 gap-8">
                  <div class="w-full overflow-hidden">
                    <div class="">
                      <div class="">
                        <img
                          src="images/resources/item5.jpg"
                          alt=""
                          class="w-full"
                        />
                      </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="blog-item">
                      <div class="blog-img">
                        <img
                          src="images/resources/item6.jpg"
                          alt=""
                          class="w-full"
                        />
                      </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="blog-item">
                      <div class="blog-img">
                        <img
                          src="images/resources/item7.jpg"
                          alt=""
                          class="w-full"
                        />
                      </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="blog-item">
                      <div class="blog-img">
                        <img
                          src="images/resources/item8.jpg"
                          alt=""
                          class="w-full"
                        />
                      </div>
                ...
                <div class="mt-6">
                  ...
                  <h3 class="text-xl font-extrabold my-4">
                    <nuxt-link to="/blog/detail" title=""
                      >The Saint Louis Art Museum Welcome Kehin de Wiley to the
                      Midwest</nuxt-link
                    >
                  </h3>
            ...
            <div class="grid grid-flow-col grid-rows-2 grid-cols-2 gap-8">
              <div class="">
                <div class="blog-item">
                  <div class="blog-img">
                    <img
                      src="images/resources/item12.jpg"
                      alt=""
                      class="w-full"
                    />
                  </div>
              ...
              <div class="">
                <div class="blog-item">
                  <div class="blog-img">
                    <img
                      src="images/resources/item13.jpg"
                      alt=""
                      class="w-full"
                    />
                  </div>
              ...
              <div class="">
                <div class="blog-item">
                  <div class="blog-img">
                    <img
                      src="images/resources/item14.jpg"
                      alt=""
                      class="w-full"
                    />
                  </div>
              ...
              <div class="">
                <div class="blog-item">
                  <div class="blog-img">
                    <img
                      src="images/resources/item15.jpg"
                      alt=""
                      class="w-full"
                    />
                  </div>
